    ...
    private DatabaseConnector(){
        try {
            ...
            try {
                ...
                statement.executeUpdate("CREATE TABLE employee_computer (log_id INT PRIMARY KEY, emp_id VARCHAR(7) NOT NULL, cmp_id VARCHAR(7) NOT NULL, login DATETIME NOT NULL, logout DATETIME NOT NULL, FOREIGN KEY (emp_id) REFERENCES employee(emp_id), FOREIGN KEY (cmp_id) REFERENCES computer(cmp_id));");
