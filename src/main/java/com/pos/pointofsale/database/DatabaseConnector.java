    ...
    private DatabaseConnector(){
        try {
            ...
            try {
                ...
                statement.executeUpdate("CREATE TABLE employee (emp_id VARCHAR(7) PRIMARY KEY, fname VARCHAR(30) NOT NULL, lname VARCHAR(30) NOT NULL, email VARCHAR(30) NOT NULL,phone_no VARCHAR(12) NOT NULL, password VARCHAR(100) NOT NULL, UNIQUE (email));");
                ...
                statement.executeUpdate("CREATE TABLE employee_computer (log_id INT PRIMARY KEY AUTO_INCREMENT, emp_id VARCHAR(7) NOT NULL, cmp_id VARCHAR(7) NOT NULL, login DATETIME NOT NULL, logout DATETIME NOT NULL, FOREIGN KEY (emp_id) REFERENCES employee(emp_id), FOREIGN KEY (cmp_id) REFERENCES computer(cmp_id));");
                ...
                statement.executeUpdate("INSERT INTO employee (emp_id, fname, lname, email,phone_no, password) VALUES ('admin','Admin','Admin','admin@gmail.com','+94710000000',MD5('1234'))");
